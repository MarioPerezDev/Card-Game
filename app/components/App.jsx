...
export class App extends React.Component {
  ...
  render(){
    ...
    if(cards){
      game = (<Game dispatch={this.props.dispatch} user_profile={this.props.user_profile} tracking={this.props.tracking} quiz={SAMPLES.quiz_example} config={GLOBAL_CONFIG} I18n={I18n}/>)
    appCards=(
      cards.map((card,i) =>
