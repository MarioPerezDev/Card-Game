					...
					<Modal.Body className="modalBody shop">
						<Row className="text-center">
							<Col lg className="shopItem">
									<img className={((activePowerUp || this.props.game.powerUp === "shield" || (this.props.game.money < 20))? "grey_opacity" : "clickable")}  onClick={(this.props.game.powerUp === "shield"  || (this.props.game.money < 20)) ? null :() => {this.props.dispatch(buy(1));this.setState({ show: false })}} src="assets/images/shield.png"></img>
						...
						<Row className="text-center">
							<Col lg className="shopItem">
									<img className={"clickable " + ((this.props.game.powerUp === "x2" || (this.props.game.money < 80))? "grey_opacity" : "")} onClick={(this.props.game.powerUp === "x2"  || (this.props.game.money < 80)) ? null: () => {this.props.dispatch(buy(3));this.setState({ show: false })}} disabled={this.props.game.powerUp === "x2"  || (this.props.game.money < 80)} src="assets/images/x2.png"></img>
							...
							<Col lg className="shopItem">
									<img className={"clickable " + ((this.props.game.powerUp === "skip" || (this.props.game.money < 100))? "grey_opacity" : "")} onClick={() => {this.props.dispatch(buy(4));this.setState({ show: false })}} disabled={this.props.game.powerUp === "skip"  || (this.props.game.money < 100)} src="assets/images/skip.png"></img>
