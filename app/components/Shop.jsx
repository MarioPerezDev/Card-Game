...
import { buyPowerUp } from '../reducers/actions';
				...
				<Modal size="lg" show={this.state.show} onHide={this.handleClose}>
					...
					<Modal.Body className="modalBody">
						<Row className="text-center">
							<Col lg>
								<div className="shopClick" onClick={this.props.dispatch(buyPowerUp(1))}>
							...
							<Col lg>
								<div className="shopClick" onClick={this.props.dispatch(buyPowerUp(2))}>
									<img className="clickable" onClick={this.handleClose} src="https://pngimage.net/wp-content/uploads/2018/05/achievement-icon-png-9.png"></img>
									<p>Esta es una mejora que ayudará a ganar la partida. Puedes utilizarla en cualquier momento. Estoy alargando el texto para ver cómo se vería.</p>              
								</div>  
							</Col>
						...
						<Row className="text-center">
							<Col lg>
								<div className="shopClick" onClick={this.props.dispatch(buyPowerUp(3))}>
									<img className="clickable" onClick={this.handleClose} src="https://pngimage.net/wp-content/uploads/2018/05/achievement-icon-png-9.png"></img>
									<p>Esta es una mejora que ayudará a ganar la partida. Puedes utilizarla en cualquier momento. Estoy alargando el texto para ver cómo se vería.</p>              
								</div>  
							</Col>
							<Col lg>
								<div className="shopClick" onClick={this.props.dispatch(buyPowerUp(4))}>
									<img className="clickable" onClick={this.handleClose} src="https://pngimage.net/wp-content/uploads/2018/05/achievement-icon-png-9.png"></img>
									<p>Esta es una mejora que ayudará a ganar la partida. Puedes utilizarla en cualquier momento. Estoy alargando el texto para ver cómo se vería.</p> 
								</div>             
							</Col>
